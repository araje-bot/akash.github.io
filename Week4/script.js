...
btnYes.addEventListener('click', () => {
  ...
  guestField.classList.remove('hidden');     // show guest count
  confirmation.classList.remove('hidden');   // show confirmation
  regret.classList.add('hidden');            // hide regret
...
btnNo.addEventListener('click', () => {
  ...
  regret.textContent = `Sorry you can't make it, ${getName()}.`;
});
...
nameInput.addEventListener('input', () => {
  ...
  if (isNotGoing) regret.textContent = `Sorry you can't make it, ${getName()}.`;
});
